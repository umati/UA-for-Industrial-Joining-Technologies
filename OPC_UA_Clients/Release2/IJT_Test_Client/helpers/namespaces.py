...
class BN:
    ...
    SIMULATE_CONDITIONS = "SimulateConditions"
...
class SimulateEventType:
    ...
    Source: SDK_Application/events/event_simulation_t.h.
    """
    ...
    # Asset/tool state
    ASSET_CONNECTED = 1
    ASSET_DISCONNECTED = 2
    ASSET_ENABLED = 3
    ASSET_DISABLED = 4
    ASSET_OVERHEATED = 5
    ASSET_STARTED = 6
    ASSET_STOPPED = 7
    ASSET_LOCATION_IN_ZONE = 8
    ASSET_LOCATION_OUT_OF_ZONE = 9

    # Asset/tool errors
    ASSET_MISSING_ERROR = 10
    ASSET_INVALID_ERROR = 11
    ASSET_INCOMPATIBLE_ERROR = 12
    ASSET_NOT_AVAILABLE_ERROR = 13

    # Software
    SOFTWARE_MISSING_ERROR = 14
    SOFTWARE_INVALID_ERROR = 15
    SOFTWARE_INCOMPATIBLE_ERROR = 16
    SOFTWARE_NOT_AVAILABLE_ERROR = 17

    # Certificate
    CERTIFICATE_EXPIRY_WARNING = 18
    CERTIFICATE_EXPIRED_ERROR = 19
    CERTIFICATE_INVALID_ERROR = 20
    CERTIFICATE_NOT_AVAILABLE_ERROR = 21
    ...
    LICENSE_ASSET_DISABLED_ERROR = 28
    ...
    STARTED_ENTITY = 31
    STOPPED_ENTITY = 32
    NOT_AVAILABLE_ENTITY_ERROR = 33
    NOT_SUPPORTED_ENTITY_ERROR = 34
    ADDED_ENTITY = 35
    REMOVED_ENTITY = 36
    UPDATED_ENTITY = 37

    # Identifier/entity validation
    RECEIVED_ENTITY = 38
    ACCEPTED_ENTITY = 39
    REJECTED_ENTITY = 40
    MISSING_ENTITY_ERROR = 41
    INVALID_ENTITY_ERROR = 42
    INCOMPATIBLE_ENTITY_ERROR = 43
    RECEIVED_AND_ACCEPTED = 44
    RECEIVED_AND_REJECTED = 45
    RECEIVED_INVALID_AND_REJECTED = 46

    # Configuration/system/user/maintenance
    CONFIGURATION_CHANGED = 47
    UNACKNOWLEDGED_RESULTS = 48
    DATA_VALIDATION_FAILURE_ERROR = 49
    INPUT_VALIDATION_FAILURE_ERROR = 50
    THRESHOLD_VIOLATION_RESOLVED = 51
    USER_LOGGED_IN = 52
    USER_LOGGED_OUT = 53
    CALIBRATION_DUE = 54
    SERVICE_DUE = 55
    CONNECTION_FAILURE = 56
    BAD_CONFIGURATION = 57
    OUT_OF_RESOURCES = 58
    MAINTENANCE_INFO = 59
    TESTING_MODE = 60

    # Compatibility aliases used by existing tests and reports.
    TOOL_CONNECTED = ASSET_CONNECTED
    TOOL_DISCONNECTED = ASSET_DISCONNECTED
    TOOL_ENABLED = ASSET_ENABLED
    TOOL_OVERHEATED = ASSET_OVERHEATED
    TOOL_STARTED = ASSET_STARTED
    TOOL_STOPPED = ASSET_STOPPED
    TOOL_LOCATION_IN_ZONE = ASSET_LOCATION_IN_ZONE
    TOOL_LOCATION_OUT_OF_ZONE = ASSET_LOCATION_OUT_OF_ZONE
    TOOL_MISSING_ERROR = ASSET_MISSING_ERROR
    TOOL_INVALID_ERROR = ASSET_INVALID_ERROR
    TOOL_INCOMPATIBLE_ERROR = ASSET_INCOMPATIBLE_ERROR
    TOOL_NOT_AVAILABLE_ERROR = ASSET_NOT_AVAILABLE_ERROR
    TOOL_SOFTWARE_MISSING = SOFTWARE_MISSING_ERROR
    TOOL_SOFTWARE_INVALID = SOFTWARE_INVALID_ERROR
    TOOL_SOFTWARE_INCOMPATIBLE = SOFTWARE_INCOMPATIBLE_ERROR
    TOOL_SOFTWARE_NOT_AVAILABLE = SOFTWARE_NOT_AVAILABLE_ERROR
    CERTIFICATE_EXPIRED = CERTIFICATE_EXPIRED_ERROR
    CERTIFICATE_NOT_AVAILABLE = CERTIFICATE_NOT_AVAILABLE_ERROR
    TOOL_LICENSE_DISABLED_ERROR = LICENSE_ASSET_DISABLED_ERROR
    PROGRAM_SELECTED = SELECTED_PROCESS
    JOINT_SELECTED = SELECTED_ENTITY
    EXECUTION_STARTED = STARTED_ENTITY
    EXECUTION_STOPPED = STOPPED_ENTITY
    JOINT_NOT_AVAILABLE = NOT_AVAILABLE_ENTITY_ERROR
    JOINT_NOT_SUPPORTED = NOT_SUPPORTED_ENTITY_ERROR
    ADDED_JOINT = ADDED_ENTITY
    REMOVED_JOINT = REMOVED_ENTITY
    UPDATED_JOINT = UPDATED_ENTITY
    RECEIVED_IDENTIFIER = RECEIVED_ENTITY
    ACCEPTED_IDENTIFIER = ACCEPTED_ENTITY
    REJECTED_IDENTIFIER = REJECTED_ENTITY
    MISSING_PROGRAM = MISSING_ENTITY_ERROR
    INVALID_PROGRAM = INVALID_ENTITY_ERROR
    INCOMPATIBLE_PROGRAM = INCOMPATIBLE_ENTITY_ERROR
    CALIBRATION_ERROR = MAINTENANCE_INFO
    CAPABILITY_TEST_ACTIVATED = TESTING_MODE

    ALL_KNOWN: list[tuple[int, str]] = [
        (ASSET_CONNECTED, "ASSET_CONNECTED"),
        (ASSET_DISCONNECTED, "ASSET_DISCONNECTED"),
        (ASSET_ENABLED, "ASSET_ENABLED"),
        (ASSET_DISABLED, "ASSET_DISABLED"),
        (ASSET_OVERHEATED, "ASSET_OVERHEATED"),
        (ASSET_STARTED, "ASSET_STARTED"),
        (ASSET_STOPPED, "ASSET_STOPPED"),
        (ASSET_LOCATION_IN_ZONE, "ASSET_LOCATION_IN_ZONE"),
        (ASSET_LOCATION_OUT_OF_ZONE, "ASSET_LOCATION_OUT_OF_ZONE"),
        (ASSET_MISSING_ERROR, "ASSET_MISSING_ERROR"),
        (ASSET_INVALID_ERROR, "ASSET_INVALID_ERROR"),
        (ASSET_INCOMPATIBLE_ERROR, "ASSET_INCOMPATIBLE_ERROR"),
        (ASSET_NOT_AVAILABLE_ERROR, "ASSET_NOT_AVAILABLE_ERROR"),
        (SOFTWARE_MISSING_ERROR, "SOFTWARE_MISSING_ERROR"),
        (SOFTWARE_INVALID_ERROR, "SOFTWARE_INVALID_ERROR"),
        (SOFTWARE_INCOMPATIBLE_ERROR, "SOFTWARE_INCOMPATIBLE_ERROR"),
        (SOFTWARE_NOT_AVAILABLE_ERROR, "SOFTWARE_NOT_AVAILABLE_ERROR"),
        (CERTIFICATE_EXPIRY_WARNING, "CERTIFICATE_EXPIRY_WARNING"),
        (CERTIFICATE_EXPIRED_ERROR, "CERTIFICATE_EXPIRED_ERROR"),
        (CERTIFICATE_INVALID_ERROR, "CERTIFICATE_INVALID_ERROR"),
        (CERTIFICATE_NOT_AVAILABLE_ERROR, "CERTIFICATE_NOT_AVAILABLE_ERROR"),
        (CERTIFICATE_ERROR, "CERTIFICATE_ERROR"),
        (LICENSE_EXPIRY_WARNING, "LICENSE_EXPIRY_WARNING"),
        (LICENSE_EXPIRED_ERROR, "LICENSE_EXPIRED_ERROR"),
        (LICENSE_INVALID_ERROR, "LICENSE_INVALID_ERROR"),
        (LICENSE_INCOMPATIBLE_ERROR, "LICENSE_INCOMPATIBLE_ERROR"),
        (LICENSE_NOT_AVAILABLE_ERROR, "LICENSE_NOT_AVAILABLE_ERROR"),
        (LICENSE_ASSET_DISABLED_ERROR, "LICENSE_ASSET_DISABLED_ERROR"),
        (SELECTED_PROCESS, "SELECTED_PROCESS"),
        (SELECTED_ENTITY, "SELECTED_ENTITY"),
        (STARTED_ENTITY, "STARTED_ENTITY"),
        (STOPPED_ENTITY, "STOPPED_ENTITY"),
        (NOT_AVAILABLE_ENTITY_ERROR, "NOT_AVAILABLE_ENTITY_ERROR"),
        (NOT_SUPPORTED_ENTITY_ERROR, "NOT_SUPPORTED_ENTITY_ERROR"),
        (ADDED_ENTITY, "ADDED_ENTITY"),
        (REMOVED_ENTITY, "REMOVED_ENTITY"),
        (UPDATED_ENTITY, "UPDATED_ENTITY"),
        (RECEIVED_ENTITY, "RECEIVED_ENTITY"),
        (ACCEPTED_ENTITY, "ACCEPTED_ENTITY"),
        (REJECTED_ENTITY, "REJECTED_ENTITY"),
        (MISSING_ENTITY_ERROR, "MISSING_ENTITY_ERROR"),
        (INVALID_ENTITY_ERROR, "INVALID_ENTITY_ERROR"),
        (INCOMPATIBLE_ENTITY_ERROR, "INCOMPATIBLE_ENTITY_ERROR"),
        (RECEIVED_AND_ACCEPTED, "RECEIVED_AND_ACCEPTED"),
        (RECEIVED_AND_REJECTED, "RECEIVED_AND_REJECTED"),
        (RECEIVED_INVALID_AND_REJECTED, "RECEIVED_INVALID_AND_REJECTED"),
        (CONFIGURATION_CHANGED, "CONFIGURATION_CHANGED"),
        (UNACKNOWLEDGED_RESULTS, "UNACKNOWLEDGED_RESULTS"),
        (DATA_VALIDATION_FAILURE_ERROR, "DATA_VALIDATION_FAILURE_ERROR"),
        (INPUT_VALIDATION_FAILURE_ERROR, "INPUT_VALIDATION_FAILURE_ERROR"),
        (THRESHOLD_VIOLATION_RESOLVED, "THRESHOLD_VIOLATION_RESOLVED"),
    ...
    USE_CASES: dict[str, list[tuple[int, str]]] = {
        "asset_state": ALL_KNOWN[0:9],
        "asset_error": ALL_KNOWN[9:13],
        "software": ALL_KNOWN[13:17],
        "certificate": ALL_KNOWN[17:22],
        "license": ALL_KNOWN[22:28],
        "process_entity_lifecycle": ALL_KNOWN[28:37],
        "identifier_entity_validation": ALL_KNOWN[37:46],
        "configuration_system_user_maintenance": ALL_KNOWN[46:60],
    }

    REPORTED_VALUE_TYPES: set[int] = {
        ASSET_OVERHEATED,
        THRESHOLD_VIOLATION_RESOLVED,
    }
