...
import { ButtonTraceInterface } from './trace-interface.mjs' // Buttons and other standard graphical elements
import ZoomHandler from './zoom-handler.mjs' // Handling different types of zoom
import TraceDisplay from './trace-display.mjs' // The trace area
