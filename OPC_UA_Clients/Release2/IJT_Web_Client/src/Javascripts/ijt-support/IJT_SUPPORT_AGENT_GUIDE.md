...
- `Models/`:
  typed model system (see `Models/MODELS_AGENT_GUIDE.md`).
...
- `Javascripts/ijt-support/Models/MODELS_AGENT_GUIDE.md`
- `Javascripts/ijt-support/Models/Results/RESULT_MODEL_GUIDE.md`
