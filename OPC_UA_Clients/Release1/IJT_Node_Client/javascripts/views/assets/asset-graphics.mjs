...
export default class AssetGraphics extends BasicScreen {
  constructor (assetManager) {
    ...
    displayArea.classList.add('draw-asset-box')
  ...
  createController (node, controllerNr, parts) {
    ...
    rightbox.classList.add('asset-area')
  ...
  createAssetContainer (node, container) {
    ...
    asset.classList.add('asset-area')
    ...
    externals.classList.add('asset-area')
  ...
  addHorizontal (node, container) {
    const mainbox = document.createElement('div')
    mainbox.classList.add('asset-box')
