...
export default class TabGenerator {
  constructor (container, identityString = 'topLevel') {
    ...
    this.tabBase.classList.add('tab-generator-base')

    this.selector = document.createElement('div')
    this.selector.classList.add('tab-select')
    ...
    this.contentDiv.classList.add('tab-content')
  ...
  displayError (messageInput) {
    ...
    contentDiv.classList.add('error-tab')
